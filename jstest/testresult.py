...
class TestResult(object):
    ...
    def create_result(self):
        ...
        labels = {
            'profiles/minimal-profile-build': 'minimal_profile',
            'profiles/target-profile-build': 'target_profile'
        }
        ...
        for job_id, build_path in self.results.iteritems():
            ...
            if 'test-build' in job_id:
                ...
                testresults = utils.read_json_file(filename)
        ...
        filename = utils.join(filepath, result['date'] + '.json')
